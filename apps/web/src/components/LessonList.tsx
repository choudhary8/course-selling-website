...
export const LessonList = () => {
  ...
  return <div className="md:mx-30 mx-2 sm:mx-8 my-8">
    <div className="flex justify-between">
      {(location.state.from==='/created-courses')&&<button onClick={handleUpload} className=" bg-blue-700 hover:bg-blue-800 text-white border-black border-1 p-3 rounded-lg cursor-pointer">Upload Lesson</button>}
