        ...
        <nav className="flex justify-between px-12 py-3 bg-gray-900 items-center sticky w-full top-0">
            ...
            <div className="flex items-center">
                ...
                <div className="px-8">
                    ...
                    {showProfile&&<div tabIndex={0} onFocus={() => setShowProfile(true)} onBlur={() => setShowProfile(false)} className="absolute right-4 bg-gray-800 p-1 top-15 border-[0.5px] border-gray-600 rounded-lg  shadow-xl">
