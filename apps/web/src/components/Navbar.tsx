            ...
            <div className="flex items-center">
                ...
                <div className="px-8">
                    ...
                    {showProfile&&<div className="absolute right-4 bg-gray-800 p-1 top-15 border-[0.5px] border-gray-600 rounded-lg  shadow-xl">
                        ...
                        <div className="cursor-pointer hover:bg-gray-700 p-1 flex items-center gap-2 rounded-sm" onClick={()=>{localStorage.removeItem('authToken')}}><MdOutlineLogout/> Logout</div>
                    </div>}
                </div>
            </div>
        </nav>
